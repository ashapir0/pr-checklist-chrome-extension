...
export const Application = () => {
  ...
  return (
    <Container sx={{ width: '100%', minHeight: '500px', p: 0, m: 0 }}>
      <Box sx={{ 
        ...
        <Box sx={{ 
          ...
          <Box sx={{ display: 'flex', gap: 1.5 }}>
            <Button
              ...
              startIcon={isLoading ? <CircularProgress size={16} color="inherit" /> : <CheckCircle sx={{ fontSize: 16 }} />}
            >
        ...
        <Box sx={{ 
          ...
          <Card variant="outlined">
            <CardContent>
              ...
              <Typography variant="subtitle1" sx={{ fontWeight: 600, color: isConnected ? 'success.main' : 'error.main' }}>
          ...
          <Box sx={{ 
            ...
            <Typography variant="body2" color="text.secondary">
              Navigate to a GitHub PR compare page and look for the "AI Auto-fill" button 
              near the description field to use the extension.
            </Typography>
          </Box>
